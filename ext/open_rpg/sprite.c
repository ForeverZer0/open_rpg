...
static VALUE rpg_sprite_update(VALUE self) {
    ...
    if (sprite->base.flash.duration) {
        sprite->base.flash.duration--;
        if (sprite->base.flash.duration == 0) {
            sprite->base.flash.color.r = 0.0f;
            sprite->base.flash.color.g = 0.0f;
            sprite->base.flash.color.b = 0.0f;
            sprite->base.flash.color.a = 0.0f;
        }
    }
    return self;
}
